...
#              的顺序真加载一遍再挨个挂载页面。
for t in tools/jstest/staples.js tools/jstest/modal.js tools/jstest/flow.js tools/jstest/pinyin.js tools/jstest/timing.js tools/jstest/notes.js tools/jstest/recipebook.js tools/jstest/boot.js; do
  [ -e "$t" ] || continue
